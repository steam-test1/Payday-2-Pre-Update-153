	...
	if threat_epicenter then
		...
		for key, enemy_data in pairs(enemies) do
			...
			if not focus_enemy_reaction or focus_enemy_reaction <= reaction then
				...
				if not (focus_enemy and (not enemy_data.verified or focus_enemy.verified)) or (enemy_data.verified or not focus_enemy.verified) and focus_enemy_angle < angle then
