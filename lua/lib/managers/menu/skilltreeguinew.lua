...
function NewSkillTreeTierItem:init(tier, tier_data, tier_panel, tree_panel, tree, tree_item, fullscreen_panel, gui)
	...
	self._tier_points:set_text(0 < tier_points and tier_points or "")
...
function NewSkillTreeTierItem:refresh_points(selected)
	...
	if self._tier_points_total then
		...
		if selected then
			...
			self._tier_points_total_curr:set_text(0 < points_spent and points_spent or "")
...
function NewSkillTreeTierItem:_refresh_tier_text(selected)
	...
	if selected then
		...
		if 0 < tier_points then
			...
			self._tier_points_needed_curr:set_text(0 < tier_points and tier_points or "")
...
function NewSkillTreeSkillItem:refresh()
	...
	icon:set_color(1 < step and tweak_data.screen_colors.text or tweak_data.screen_colors.button_stage_3)
	icon:set_alpha(not unlocked and (self._selected and 0.7 or 0.5) or 1 < step and 1 or self._selected and 0.8 or 0.6)
