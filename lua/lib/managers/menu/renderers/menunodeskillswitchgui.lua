...
function MenuNodeSkillSwitchGui:_create_menu_item(row_item)
	...
	elseif row_item.type ~= "divider" and row_item.name ~= "back" then
		...
		if unlocked then
			...
			distribution_text = distribution_text .. managers.localization:to_upper_text(0 < points and "menu_st_points_unspent_skill_switch" or "menu_st_points_all_spent_skill_switch", {
