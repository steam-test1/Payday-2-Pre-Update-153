...
function PlayerManager:add_special(params)
	...
	local quantity = (not self:has_category_upgrade(name, "quantity_unlimited") or not -1) and equipment.quantity and (not respawn or not math.min(params.amount, (equipment.max_quantity or equipment.quantity) + extra)) and equipment.quantity and math.min(amount + extra, (equipment.max_quantity or equipment.quantity) + extra)
